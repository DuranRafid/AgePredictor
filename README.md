...
Selected top N highly variable genes using method `seurat` from `scanpy`, where N <img src="https://render.githubusercontent.com/render/math?math=\epsilon"> {10, 50, 100, 1000}
